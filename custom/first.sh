...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b g-dock --depth 1 https://github.com/dlonzyz/common build/common
...
git clone -b main --depth 1 https://github.com/dlonzyz/build-actions shangyou
